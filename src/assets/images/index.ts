...
export const Background = require('./sign_background.png');
...
export const Pepsi = require('./pepsi.png');
export const sevenup = require('./sevenup.png');
export const mirinda = require('./mirinda.png');
export const coinbadge = require('./coinbadge.png');